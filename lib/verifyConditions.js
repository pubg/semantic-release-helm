...
module.exports = async function (pluginConfig, context) {
    ...
    await verifyOCIRegistry(ociRegistry, HELM_REPOSITORY_USERNAME, HELM_REPOSITORY_PASSWORD)
    await verifyChartRepository(chartRepository, HELM_REPOSITORY_USERNAME, HELM_REPOSITORY_PASSWORD)
}